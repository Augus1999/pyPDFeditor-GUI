...
class MainR(QTabWidget):
    ...
    def tab4_init(self) -> None:
        ...
        self.tab4.grid.addWidget(self.tab4.text, 5, 0, 8, 7, QtCore.Qt.AlignCenter)
        self.tab4.grid.addWidget(self.tab4.table, 1, 7, 20, 7)
        self.tab4.grid.addWidget(self.tab4.label1, 2, 0, 3, 5, QtCore.Qt.AlignCenter)
        self.tab4.grid.addWidget(self.tab4.label2, 2, 14, 1, 7, QtCore.Qt.AlignCenter)
        self.tab4.grid.addWidget(self.tab4.label3, 4, 14, 1, 7, QtCore.Qt.AlignCenter)
        self.tab4.grid.addWidget(self.tab4.label4, 6, 14, 1, 7, QtCore.Qt.AlignCenter)
        self.tab4.grid.addWidget(self.tab4.label5, 8, 14, 1, 7, QtCore.Qt.AlignCenter)
        self.tab4.grid.addWidget(self.tab4.line1, 3, 14, 1, 7, QtCore.Qt.AlignCenter)
        self.tab4.grid.addWidget(self.tab4.line2, 5, 14, 1, 7, QtCore.Qt.AlignCenter)
        self.tab4.grid.addWidget(self.tab4.line3, 7, 14, 1, 7, QtCore.Qt.AlignCenter)
        self.tab4.grid.addWidget(self.tab4.line4, 9, 14, 1, 7, QtCore.Qt.AlignCenter)
